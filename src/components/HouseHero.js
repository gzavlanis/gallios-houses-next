    ...
    return (
        <header style={{
            ...
            <div className="container text-center" style={{ position: 'relative', zIndex: 2, color: 'white' }}>
                <p style={{ letterSpacing: '4px', textTransform: 'uppercase', marginBottom: '15px', fontSize: '12px', fontWeight: 'bold', color: '#cba135' }}>
                    {subtitle}
                </p>
                <h1 style={{ fontSize: '4rem', marginBottom: '20px', fontFamily: 'var(--font-heading)' }}>
                    {title}
                </h1>
